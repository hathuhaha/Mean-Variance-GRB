...
void SetupModel(ofstream& output, const int& N, vector<double>& Mean, vector<vector<double>>& Covariance, const int& P, string SetupType, const double& Constraint) {
	GRBEnv env;
